 ...
 */
@Component
public class GameTeamServiceFallbackProvider extends BaseFallbackProvider {

    public GameTeamServiceFallbackProvider() {
        super.setServiceId(ServicesEnum.GAMINGTEAM_SERVICE);
    }
}