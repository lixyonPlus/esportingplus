 ...
 */
@Component
public class TradeServiceFallbackProvider extends BaseFallbackProvider {

    public TradeServiceFallbackProvider() {
        super.setServiceId(ServicesEnum.TRADE_SERVICE);
    }
}