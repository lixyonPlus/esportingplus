...
public class PerformanceProfilerMonitor {
    ...
    public static void enable(boolean enabled) {
        PerformanceProfilerMonitor.enabled = enabled;
        reset();
    }
        ...
        private void toString(StringBuilder buffer, String prefix1, String prefix2) {
            ...
            for (int i = 0; i < subEntries.size(); i++) {
                ...
                if (i == (subEntries.size() - 1)) {
                    subEntry.toString(buffer, prefix2 + "end---", prefix2 + "    "); // 最后一项
                } else if (i == 0) {
                    subEntry.toString(buffer, prefix2 + "mid---", prefix2 + "|   "); // 第一项
                } else {
                    subEntry.toString(buffer, prefix2 + "mid---", prefix2 + "|   "); // 中间项
                }
            }
        }
    }
